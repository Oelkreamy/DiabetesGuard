...
model = pickle.load(open(r'D:\OMAR\courses\depi-IBM-Data-Science\DiabetesGuard\Source\Diabetes_prediction.sav', 'rb'))

# Load the scaler
scaler = pickle.load(open(r'D:\OMAR\courses\depi-IBM-Data-Science\DiabetesGuard\Source\scaler.sav', 'rb'))
